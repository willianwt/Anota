...
public class LembretesDisciplinaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    new RecyclerItemClickListener(
                            ...
                            new RecyclerItemClickListener.OnItemClickListener() {
                                ...
                                public void onItemClick(View view, int position) {
                                    ...
                                    Intent intent = new Intent(LembretesDisciplinaActivity.this, AtualizarLembreteDisciplinaActivity.class);
                                ...
                                public void onLongItemClick(View view, final int position) {
                                    ...
                                    AlertDialog.Builder alertDialog = new AlertDialog.Builder(LembretesDisciplinaActivity.this);
                                    ...
                                    alertDialog.setPositiveButton("Confirmar", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            ...
                                            Toast.makeText(LembretesDisciplinaActivity.this, "Exclusão Confirmada!", Toast.LENGTH_SHORT).show();
                                            Log.d("teste", "ola");
                                    ...
                                    alertDialog.setNegativeButton("Cancelar", new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            Toast.makeText(LembretesDisciplinaActivity.this, "Exclusão Cancelada!", Toast.LENGTH_SHORT).show();
                                        }
                                    });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(LembretesDisciplinaActivity.this, AdicionarLembreteDisciplinaActivity.class);
                intent.putExtra("disciplina", disciplina);
                startActivity(intent);
            }
        });
